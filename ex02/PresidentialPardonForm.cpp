...
PresidentialPardonForm::PresidentialPardonForm() : Form("PresidentialPardonForm", 25, 5), _target("President") {
...
PresidentialPardonForm::PresidentialPardonForm(std::string param_target) :Form(param_target, 25, 5) {
...
PresidentialPardonForm PresidentialPardonForm::operator=(const PresidentialPardonForm &rhs) {
	...
	std::cout << "[PresidentialPardonForm] Assignment operator was called" << std::endl;
	return *this;
}
